...
import com.sxt.mall.web.ums.vo.UmsAdminLoginParam;
import com.sxt.mall.web.ums.vo.UmsAdminParam;
import com.sxt.mall.web.utils.JwtTokenUtil;
...
//        Admin admin = null;
    ...
    public Object delete(@PathVariable Long id) {
        //TODO 删除指定用户信息
        Integer delete = this.adminService.delete(id);
        if (delete > 0) {
